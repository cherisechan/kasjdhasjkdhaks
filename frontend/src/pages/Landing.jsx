...
const Landing = () => {
  ...
  return (
    <div className="flex flex-col justify-center min-h-screen bg-gradient-to-r from-violet-500 to-violet-500 text-white p-20">
      <h1 className="text-8xl font-bold mb-4">Welcome to Presto</h1>
      <p className="text-xl mb-8 max-w-lg"> Blah blah blah </p>
